...
background: ${props => (props.primary ? "#8e44ad" : props.secondary ? "#EA2027" : "#f4efd3")};
color: ${props => (props.primary ? "white" : props.secondary ? "#55E6C1" :"blue")};
font-size: 1em;
margin: 1em;
padding: 0.25em 1em;
border: 2px solid ${props=>props.primary ? "white" : props.secondary ? "#55E6C1" : "blue"};
border-radius: 3px;
cursor:pointer;
`;
...
console.log("props: ",props)
  ...
  return <ThemeButtons>
<Button primary onClick={()=>switchTheme("dark")} >Dark Mode </Button>
<Button secondary onClick={()=>switchTheme("light")}>Ligth Mode</Button>
